...
VALUES (1, 'posta que el mejor depto', 'el mejor depto', 'APARTMENT', 1, true, 5, 100, 1)
ON CONFLICT DO NOTHING;

INSERT INTO properties(
    id, description, caption, propertytype, neighbourhoodid, privacylevel, capacity, price, mainimageid)
VALUES (2, 'posta que el mejor depto', 'el mejor depto', 'APARTMENT', 1, true, 5, 100, 1)
ON CONFLICT DO NOTHING;

INSERT INTO properties(
    id, description, caption, propertytype, neighbourhoodid, privacylevel, capacity, price, mainimageid)
VALUES (3, 'posta que el mejor depto', 'el mejor depto', 'APARTMENT', 1, true, 5, 100, 1)
ON CONFLICT DO NOTHING;

INSERT INTO properties(
    id, description, caption, propertytype, neighbourhoodid, privacylevel, capacity, price, mainimageid)
VALUES (4, 'posta que el mejor depto', 'el mejor depto', 'APARTMENT', 1, true, 5, 100, 1)
ON CONFLICT DO NOTHING;

INSERT INTO properties(
    id, description, caption, propertytype, neighbourhoodid, privacylevel, capacity, price, mainimageid)
VALUES (5, 'posta que el mejor depto', 'el mejor depto', 'APARTMENT', 1, true, 5, 100, 1)
ON CONFLICT DO NOTHING;

INSERT INTO properties(
    id, description, caption, propertytype, neighbourhoodid, privacylevel, capacity, price, mainimageid)
VALUES (6, 'posta que el mejor depto', 'el mejor depto', 'APARTMENT', 1, true, 5, 100, 1)
ON CONFLICT DO NOTHING;
